                                ...
                                <div id="campos_paginas_html" style="display: none;">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" id="numero_paginas_html" name="numero_paginas_html">
                                            ...
                                            <option value="11">11 páginas</option>
                                            <option value="12">12 páginas</option>
                                            <option value="13">13 páginas</option>
                                            <option value="14">14 páginas</option>
                                            <option value="15">15 páginas</option>
                                            <option value="16">16 páginas</option>
                                            <option value="17">17 páginas</option>
                                            <option value="18">18 páginas</option>
                                            <option value="19">19 páginas</option>
