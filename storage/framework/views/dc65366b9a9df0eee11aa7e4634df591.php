            ...
            <form id="duplicateForm" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text">
                            A nova página será criada como: <span id="newPagePreview" class="text-muted"></span>
                        </div>
                    </div>
                </div>
...
document.getElementById('duplicateForm').addEventListener('submit', function(e) {
    ...
    if (!/^[a-zA-Z0-9_]+$/.test(newName)) {
        e.preventDefault();
        alert('O nome da página deve conter apenas letras, números e underscore (_).');
        return;
    }
...
<?php echo $__env->make('dashboard.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hoogli-templats-link\resources\views/dashboard/theme-pages/index.blade.php ENDPATH**/ ?>