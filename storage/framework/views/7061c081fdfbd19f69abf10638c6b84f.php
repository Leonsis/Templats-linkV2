                    ...
                    <div data-hover="true" data-delay="0" class="nav-dropdown large w-dropdown">
                        ...
                        <nav class="nav-dropdown-list large w-dropdown-list">
                            <div class="nav-dropdown-link-holder">
                                <div>
                                    <div>
                                        <a href="<?php echo e(route('tema.Dentista24h.seguranca-de-eventos')); ?>"  class="nav-dropdown-link w-dropdown-link">Segurança de Eventos</a>
                                        <a href="<?php echo e(route('tema.Dentista24h.gerenciamento-condominios')); ?>" class="nav-dropdown-link w-dropdown-link">Gerenciamento Condomínios</a>
                                        <a href="<?php echo e(route('tema.Dentista24h.seguranca-patrimonial')); ?>" class="nav-dropdown-link w-dropdown-link">Segurança Patrimonial</a>
                                        <a href="<?php echo e(route('tema.Dentista24h.terceirizacao-geral')); ?>" class="nav-dropdown-link w-dropdown-link">Terceirização Geral</a>
                                    </div>
                                </div>
                            </div>
                        </nav>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Templats-linkV2/resources/views/temas/Dentista24h/inc/nav.blade.php ENDPATH**/ ?>