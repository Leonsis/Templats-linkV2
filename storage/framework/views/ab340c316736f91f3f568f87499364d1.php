<head>
    ...
    <?php else: ?>
        <title><?php echo e(\App\Helpers\HeadHelper::getMetaTitle($currentPage ?? 'global', 'Dentista24h')); ?></title>
        <meta name="description" content="<?php echo e(\App\Helpers\HeadHelper::getMetaDescription($currentPage ?? 'global', 'Dentista24h')); ?>">
        <meta name="keywords" content="<?php echo e(\App\Helpers\HeadHelper::getMetaKeywords($currentPage ?? 'global', 'Dentista24h')); ?>">
    <?php endif; ?>
    ...
    <link href="<?php echo e(asset('temas/Dentista24h/assets/css/normalize.css')); ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo e(asset('temas/Dentista24h/assets/css/webflow.css')); ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo e(asset('temas/Dentista24h/assets/css/griffo-ef20db.webflow.css')); ?>" rel="stylesheet" type="text/css">
    ...
    <link href="<?php echo e(asset('temas/Dentista24h/assets/images/webclip.webp')); ?>" rel="apple-touch-icon">
    <?php
    ...
    <?php endif; ?>
</head><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/hoogli-templats-link/resources/views/temas/Dentista24h/inc/head.blade.php ENDPATH**/ ?>