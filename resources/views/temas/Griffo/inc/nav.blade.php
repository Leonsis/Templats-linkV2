    ...
    <section class="home-banner first-version">
        ...
        <div class="container-large w-container">
            ...
            <div class="nav-menu-whole-area">
                ...
                <div class="nav-link-area">
                    ...
                    <div data-hover="true" data-delay="0" class="nav-dropdown large w-dropdown">
                        ...
                        <nav class="nav-dropdown-list large w-dropdown-list">
                            <div class="nav-dropdown-link-holder">
                                <div>
                                    <div>
                                        <a href="{{ route('tema.Griffo.seguranca-de-eventos') }}"  class="nav-dropdown-link w-dropdown-link">Segurança de Eventos</a>
                                        <a href="{{ route('tema.Griffo.gerenciamento-condominios') }}" class="nav-dropdown-link w-dropdown-link">Gerenciamento Condomínios</a>
                                        <a href="{{ route('tema.Griffo.seguranca-patrimonial') }}" class="nav-dropdown-link w-dropdown-link">Segurança Patrimonial</a>
                                        <a href="{{ route('tema.Griffo.terceirizacao-geral') }}" class="nav-dropdown-link w-dropdown-link">Terceirização Geral</a>
                                    </div>
                                </div>
                            </div>
                        </nav>
                    ...
                    <a href="{{ route('tema.Griffo.blogs') }}" class="nav-link w-nav-link">Blog</a>
        ...
        <div class="nav-link-area">
            ...
            <a href="{{ route('tema.Griffo.blogs') }}" class="nav-link">Blog</a>
        </div>
        <div class="nav-button-wrap">
