<head>
    ...
    @else
        <title>{{ \App\Helpers\HeadHelper::getMetaTitle($currentPage ?? 'global', 'Griffo') }}</title>
        <meta name="description" content="{{ \App\Helpers\HeadHelper::getMetaDescription($currentPage ?? 'global', 'Griffo') }}">
        <meta name="keywords" content="{{ \App\Helpers\HeadHelper::getMetaKeywords($currentPage ?? 'global', 'Griffo') }}">
    @endif
    ...
    <link href="{{ asset('temas/Griffo/assets/css/normalize.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('temas/Griffo/assets/css/webflow.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('temas/Griffo/assets/css/griffo-ef20db.webflow.css') }}" rel="stylesheet" type="text/css">
    ...
    <link href="{{ asset('temas/Griffo/assets/images/webclip.webp') }}" rel="apple-touch-icon">
    @php
