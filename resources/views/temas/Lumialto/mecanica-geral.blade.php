...
<main class="main-wrapper">
      <header class="section_header47 color-scheme-5">
                ...
                <div class="w-layout-grid header47_content">
                  <div class="header47_content-left">
                    <div class="margin-bottom margin-xsmall">
                      <div class="text-style-tagline">Qualidade</div>
                    </div>
                    <h1 class="heading-style-h1">Mecânica de Confiança</h1>
                  </div>
                  <div class="header47_content-right">
                    <p class="text-size-medium">Na Lumiauto, oferecemos serviços completos de mecânica geral para garantir que seu carro esteja sempre em perfeitas condições. Nossa equipe técnica qualificada utiliza apenas peças de alta qualidade para proporcionar segurança e desempenho ao seu veículo.</p>
                    <div class="margin-top margin-medium">
                      <div class="button-group">
                        <a  onclick="openWhatsAppModal()" class="button w-button">Saiba Mais</a>
                        <a  onclick="openWhatsAppModal()" class="button is-secondary w-button">Agende</a>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="w-layout-grid layout27_content">
                  <div class="layout27_content-left">
                    <div class="margin-bottom margin-small">
                      <h2 class="heading-style-h3">Troca de Óleo e Filtros: A Manutenção que Seu Motor Merece</h2>
                    </div>
                    <div class="margin-bottom margin-medium">
                      <p class="text-size-medium">A troca de óleo e filtros é fundamental para a saúde do motor. Ela garante que seu carro funcione de maneira eficiente e prolonga sua vida útil.</p>
                    </div>
                    <div class="w-layout-grid layout27_item-list">
                      <div class="layout27_text-wrapper">
                        <div class="margin-bottom margin-xxsmall">
                          <div class="heading-style-h2">Essencial</div>
                        </div>
                        <p>Mantenha seu motor sempre em ótimo estado.</p>
                      </div>
                      <div class="layout27_text-wrapper">
                        <div class="margin-bottom margin-xxsmall">
                          <div class="heading-style-h2">Segurança</div>
                        </div>
                        <p>Evite problemas e dirija com confiança.</p>
                      </div>
                    </div>
                    <div class="margin-top margin-medium">
                        <div class="button-group">
                  ...
                  <div class="layout27_image-wrapper"><img alt="" src="{{ asset('temas/Lumialto/assets/images/relume-291657.jpeg') }}"" loading="eager" class="layout27_image"></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="section_layout209 color-scheme-1" style="background: #b2b2b2;">
        <div class="padding-global">
          <div class="container-large">
            <div class="padding-section-large">
              <div class="layout209_component">
                <div class="w-layout-grid layout209_content">
                  <div class="layout209_image-wrapper"><img alt="" src="{{ asset('temas/Lumialto/assets/images/relume-291668.jpeg') }}"" loading="eager" class="layout209_image"></div>
                  <div id="w-node-_5440a254-b9ca-2ff8-5250-590403b2bb1a-46924920" class="layout209_content-right">
                    <div class="margin-bottom margin-small">
                      <h2 class="heading-style-h3">Serviços de Freios, Embreagem e Suspensão para Seu Veículo</h2>
                    </div>
                    <div class="margin-bottom margin-small">
                      <p class="text-size-medium">Na Lumiauto, oferecemos serviços especializados de reparo e troca de freios, embreagem e suspensão. Nossa equipe técnica garante a segurança e a performance do seu veículo em cada serviço realizado.</p>
                    </div>
                    <div class="layout209_item-list ">
                      <div id="w-node-_5440a254-b9ca-2ff8-5250-590403b2bb22-46924920" class="layout209_item">
                        <div class="layout209_item-icon-wrapper text-size-medium">
                          <div class="icon-embed-xsmall w-embed"><svg  width="100%" height="100%" viewbox="0 -960 960 960">
              ...
              <div class="layout16_component">
                <div class="w-layout-grid layout16_content">
                  <div class="layout16_content-left">
                    <div class="margin-bottom margin-xsmall">
                      <div class="text-style-tagline">Diagnóstico</div>
                    </div>
                    <div class="margin-bottom margin-small">
                      <h2 class="heading-style-h2">Injeção Eletrônica e Diagnóstico de Precisão</h2>
                    </div>
                    <div class="margin-bottom margin-small">
                      <p class="text-size-medium">Na Lumiauto, utilizamos equipamentos de ponta para garantir diagnósticos precisos e reparos eficientes. Nossa equipe técnica está sempre pronta para atender suas necessidades automotivas.</p>
                    </div>
                    <div class="layout16_item-list">
                      <div id="w-node-_5440a254-b9ca-2ff8-5250-590403b2bb45-46924920" class="layout16_item">
                        <div class="layout16_item-icon-wrapper">
                          <div class="icon-embed-xsmall w-embed"><svg  width="100%" height="100%" viewbox="0 -960 960 960">
                              <path fill="currentColor" d="M37.37-296.64v-63.01q0-14.46 9.82-24.15 9.82-9.7 24.24-9.7h407.61L102.63-684.63v111.26q0 13.97-9.42 23.42-9.41 9.45-23.34 9.45-13.92 0-23.21-9.45-9.29-9.45-9.29-23.42v-160.98q0-19.77 16.53-29.66 16.53-9.88 33.69-.92l458.28 253.02v-256.66q0-14.42 9.82-24.24 9.82-9.82 24.24-9.82h110.4q15.56 0 29.4 6.63 13.84 6.62 23.29 18.72L907.2-579.15q7.34 9.52 11.39 20.63 4.04 11.11 4.04 23.15v238.8q0 14.43-9.82 24.25t-24.24 9.82h-62.94q0 46.2-32.21 78.41-32.21 32.22-78.41 32.22-46.21 0-78.42-32.19-32.22-32.18-32.22-78.44H351.63q0 46.2-32.21 78.41-32.21 32.22-78.41 32.22-46.21 0-78.42-32.19-32.22-32.18-32.22-78.44H71.43q-14.42 0-24.24-9.84-9.82-9.84-9.82-24.3Zm203.67 96.27q25.88 0 44.11-18.2 18.22-18.19 18.22-43.96t-18.27-44.06q-18.27-18.28-44.14-18.28-25.88 0-44.11 18.27-18.22 18.27-18.22 44.14 0 25.78 18.27 43.94 18.27 18.15 44.14 18.15Zm474 0q25.88 0 44.11-18.2 18.22-18.19 18.22-43.96t-18.27-44.06q-18.27-18.28-44.14-18.28-25.88 0-44.11 18.27-18.22 18.27-18.22 44.14 0 25.78 18.27 43.94 18.27 18.15 44.14 18.15ZM611.37-560h226.8L691.52-737.37h-80.15V-560Z"></path>
                            </svg></div>
                        </div>
                        <div class="layout16_item-text-wrapper">
                          <p>Tecnologia avançada para o cuidado do seu carro.</p>
                        </div>
                      </div>
                      <div id="w-node-_5440a254-b9ca-2ff8-5250-590403b2bb4b-46924920" class="layout16_item">
                        <div class="layout16_item-icon-wrapper">
                          <div class="icon-embed-xsmall w-embed"><svg  width="100%" height="100%" viewbox="0 -960 960 960">
                              <path fill="currentColor" d="M480.44-161.67q-6.97 0-13.8-1.62-6.84-1.62-12.31-5.86-43.76-28.76-92.85-45.26-49.09-16.5-101.45-16.5-41.55 0-81.45 11-39.91 11-76.43 30.76-23.63 12.19-45.64-1.21-22.01-13.4-22.01-39.1v-481.52q0-13.54 6.46-25.59 6.45-12.04 19.37-18.06 46.24-23.76 96.59-35.52 50.36-11.76 102.59-11.76 58.25 0 113.99 14.94 55.74 14.94 106.5 45.54v511.97q51-32.88 107-49.91 56-17.04 113-17.04 36 0 78.5 7.3 42.5 7.29 81.5 29.18v-512.18q10.36 3.99 20.28 8.23 9.92 4.25 19.63 9.25 12.16 6.72 18.87 18.57 6.72 11.84 6.72 25.08v484.39q0 24.92-22.01 37.39-22.01 12.48-45.64.05-36.52-19.76-76.46-30.76-39.93-11-81.34-11-52.19 0-100.93 16.51-48.74 16.52-92.25 45.25-5.48 4.24-12.35 5.86-6.88 1.62-14.08 1.62Zm88.39-186.37q-8.96 6.95-18.9 2.85-9.93-4.1-9.93-15.53v-313.76q0-3.38 1.12-6.21 1.12-2.84 3.36-5.22l225.69-226.66q7.96-7.95 18.9-3.77Q800-912.16 800-900.89v343.28q0 3.6-1.55 6.7t-3.93 5.74L568.83-348.04ZM414.5-262.09v-438.76q-32.8-18.28-76.25-26.92-43.44-8.64-78.25-8.64-47 0-87.5 9.76T100-701.84v441.67q35-17.24 75.5-26.74t85-9.5q43.32 0 82 9.01 38.67 9.02 72 25.31Zm0 0v-439 439Z"></path>
                            </svg></div>
                        </div>
                        <div class="layout16_item-text-wrapper">
                          <p>Serviços rápidos e confiáveis para seu veículo.</p>
                        </div>
                      </div>
                      <div id="w-node-_5440a254-b9ca-2ff8-5250-590403b2bb51-46924920" class="layout16_item">
                        <div class="layout16_item-icon-wrapper">
                          <div class="icon-embed-xsmall w-embed"><svg  width="100%" height="100%" viewbox="0 -960 960 960">
                              <path fill="currentColor" d="M480-293.26q78.64 0 135.34-56.68t56.7-135.22q0-78.55-56.73-135.25-56.72-56.7-135.34-56.7-78.61 0-135.19 56.69-56.58 56.68-56.58 135.24 0 78.55 56.58 135.23 56.58 56.69 135.22 56.69Zm18.43-194.53 68.77 62.77q6.23 5.48 6.62 13.93.38 8.46-5.93 14.74-5.31 5.48-13.37 5.98-8.06.5-14.48-4.98l-75.28-69.28q-5.48-4.76-8.34-11.14-2.85-6.39-2.85-13.49v-100.82q0-9.75 6.32-16.09 6.32-6.33 15.96-6.33 9.63 0 16.11 6.33 6.47 6.34 6.47 16.06v102.32ZM480-78.26q-6.04 0-11.31-1.12-5.28-1.12-10.32-3.36-140.2-47-222.27-170.67-82.08-123.68-82.08-269.7v-194.22q0-21.88 12.19-39.56 12.19-17.68 32.07-25.33l257.85-96.28q12.2-4.48 23.87-4.48 11.67 0 23.87 4.48l257.85 96.28q19.88 7.65 32.19 25.33 12.31 17.68 12.31 39.56v194.22q0 146.02-82.2 269.7-82.19 123.67-222.39 170.67-5.04 2.24-10.32 3.36-5.27 1.12-11.31 1.12Zm0-66.65q113.8-39.2 185.83-143.62 72.02-104.43 72.02-234.4v-194.4L480-814.61l-257.85 97.4v194.17q0 130.08 72.02 234.51Q366.2-184.11 480-144.91Zm0-334.85Z"></path>
                            </svg></div>
                        </div>
                        <div class="layout16_item-text-wrapper">
                          <p>Agende seu diagnóstico e mantenha seu carro seguro.</p>
                        </div>
                      </div>
                    </div>
                    <div class="margin-top margin-medium">
                      <div class="button-group">
                        <a href="#" class="button w-button">Saiba</a>
                  ...
                  <div class="layout16_image-wrapper"><img  alt="" src="{{ asset('temas/Lumialto/assets/images/relume-291693.jpeg') }}"" loading="eager" class="layout16_image"></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="section_layout201 color-scheme-1">
        <div class="padding-global">
          <div class="container-large">
            <div class="padding-section-large">
              <div class="layout201_component">
                <div class="w-layout-grid layout201_content">
                  <div class="layout201_image-wrapper"><img alt="" src="{{ asset('temas/Lumialto/assets/images/relume-291701.jpeg') }}"" loading="eager" class="layout201_image"></div>
                  <div id="w-node-_5440a254-b9ca-2ff8-5250-590403b2bb69-46924920" class="layout201_content-right">
                    <div class="margin-bottom margin-xsmall">
                      <div class="text-style-tagline">Manutenção</div>
                    </div>
                    <div class="margin-bottom margin-small">
                      <h2 class="heading-style-h2">Revisões Periódicas: Cuide do Seu Carro</h2>
                    </div>
                    <div class="margin-bottom margin-medium">
                      <p class="text-size-medium">As revisões periódicas são essenciais para garantir que seu veículo funcione perfeitamente. Com um programa de manutenção adequado, você evita problemas futuros e prolonga a vida útil do seu carro.</p>
                    </div>
                    <div class="w-layout-grid layout201_item-list">
                      <div class="layout201_item">
                        <div class="margin-bottom margin-xsmall">
                          <div class="layout201_item-icon-wrapper">
                            <div class="icon-1x1-medium w-embed"><svg  width="100%" height="100%" viewbox="0 -960 960 960">
      ...
      <section class="section_testimonial5 color-scheme-5">
        <div class="padding-global">
          <div class="container-large">
            <div class="padding-section-large">
              <div class="testimonial5_component">
                <div class="margin-bottom margin-xxlarge">
                  <div class="max-width-large">
                    <div class="margin-bottom margin-small">
                      <h2 class="heading-style-h2">Depoimentos de Clientes</h2>
                    </div>
                    <p class="text-size-medium">A qualidade e eficiência que você merece!</p>
                  </div>
                </div>
                <div class="testimonial5_grid-list">
                  <div class="testimonial5_content">
                    <div class="margin-bottom margin-medium">
                      <div class="testimonial5_rating-wrapper">
                        <div class="testimonial5_rating-icon">
                          <div class="icon-embed-xsmall w-embed"><svg width="100%" viewbox="0 0 18 17" fill="none" >
                    ...
                    <h3 class="heading-style-h6">&quot;O serviço foi impecável, meu carro voltou como novo!&quot;</h3>
                    <div class="margin-top margin-medium">
                      <div class="testimonial5_client">
                        <div class="testimonial5_client-image-wrapper"><img loading="lazy" src="{{ asset('temas/Lumialto/assets/images/Face2.jpeg') }}"" alt="" class="testimonial5_client-image"></div>
                        <div class="testimonial5_client-info">
                          <div class="text-weight-semibold">Ana Silva</div>
                          <div>Gerente, AutoShop</div>
                        </div>
                  ...
                  <div class="testimonial5_content">
                    ...
                    <h3 class="heading-style-h6">&quot;Atendimento rápido e eficaz, super recomendo a Lumiauto!&quot;</h3>
                    <div class="margin-top margin-medium">
                      <div class="testimonial5_client">
                        <div class="testimonial5_client-image-wrapper"><img loading="lazy" src="{{ asset('temas/Lumialto/assets/images/Face1.jpeg') }}"" alt="" class="testimonial5_client-image"></div>
                        <div class="testimonial5_client-info">
                          <div class="text-weight-semibold">Carlos Oliveira</div>
                          <div>Proprietário, Oficina</div>
                        </div>
                        <div class="divider-vertical"></div>
                      </div>
                    </div>
