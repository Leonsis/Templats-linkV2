...
<main class="main-wrapper">
                  ...
                  <div class="header1_content-left">
                    ...
                    <div class="margin-top margin-medium">
                      <div class="button-group">
                        <a  onclick="openWhatsAppModal()" class="button w-button">Solicite um orçamento</a>
                      </div>
                    </div>
                  </div>
                  <div class="header1_image-wrapper"><img alt="" src="{{ asset('temas/Lumialto/assets/images/relume-291771.jpeg') }}" loading="eager" class="header1_image"></div>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="contact17_component">
                <div class="w-layout-grid contact17_grid-list">
                  <div class="contact17_item">
                    <div class="margin-bottom margin-small">
                      <div class="contact17_icon-wrapper">
                        <div class="icon-embed-medium w-embed text-size-medium"><svg  width="100%" height="100%" viewbox="0 0 24 24" fill="none" preserveaspectratio="xMidYMid meet" aria-hidden="true" role="img">
                    ...
                    <div class="margin-bottom margin-xsmall">
                      <div class="heading-style-h4 text-size-medium">E-mail</div>
                    </div>
                  ...
                  <div class="contact17_item">
                    ...
                    <div class="margin-bottom margin-xsmall">
                      <div class="heading-style-h4 text-size-medium">Telefone</div>
                    </div>
                  ...
                  <div class="contact17_item">
                    ...
                    <div class="margin-bottom margin-xsmall">
                      <div class="heading-style-h4 text-size-medium">Endereço</div>
                    </div>
                    <p class="text-size-medium">Visite nossa oficina para um atendimento personalizado e serviços de qualidade.</p>
                    <div class="margin-top margin-small">
                      <a  class="text-style-link text-size-medium">SIA Trecho 3 - Guará, Brasília</a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="padding-section-large">
              <div class="contact2_component">
                ...
                <div class="max-width-large align-center">
                  ...
                  <form method="POST" class="contact2_form" id="contactForm" action="{{ route('leads.store') }}">
                      @csrf
                        <div class="form_field-2col">
                            <div class="form_field-wrapper">
                                <label for="Contact-2-First-Name-2" class="form_field-label">Nome</label>
                                <input class="form_input w-input" maxlength="256" name="nome" placeholder="Nome" type="text" required="true">
                            </div>
                            <div class="form_field-wrapper">
                                <label for="Contact-2-Email-2" class="form_field-label">Telefone</label>
                                <input class="form_input w-input" maxlength="256" name="telefone" placeholder="Telefone" type="tel" required="true">
                            </div>
                        </div>
                        <div class="form_field-2col is-mobile-1col">
                            <div class="form_field-wrapper">
                                <label for="Contact-2-Phone" class="form_field-label">E-mail</label>
                                <input class="form_input w-input" maxlength="256" name="email" placeholder="E-mail" type="text" required="true">
                            </div>
                        </div>
                        <button type="submit" class="button w-button">Enviar</button>
                    </form>
                    @if(session('success'))
    ...
    <script>
    // Capturar submit do formulário de contato
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (contactForm) {
            contactForm.addEventListener('submit', function(e) {
                ...
                console.log('Formulário de contato submetido:', formData);
            });
        }
    });
    </script>
