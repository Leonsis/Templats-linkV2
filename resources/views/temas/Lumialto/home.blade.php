                                    ...
                                    <div class="header1_content-left">
                                        <div class="margin-bottom margin-small">
                                            <h1 class="heading-style-h1">
                                                Bem-vindo à Lumiauto:
                                                Excelência em Serviços
                                                Automotivos
                                            </h1>
                                        </div>
                                        <p class="text-size-medium">
                                            Na Lumiauto, oferecemos serviços
                                            de Martelinho de Ouro, Mecânica
                                            Geral, Lanternagem e Pintura com
                                            qualidade e agilidade. Confie em
                                            nossa equipe para devolver ao
                                            seu carro o desempenho e a
                                            estética de fábrica.
                                        </p>
                                        <div class="margin-top margin-medium">
                                            <div class="button-group">
                                                <a  onclick="openWhatsAppModal()" class="button w-button">Saiba Mais</a>
                                                <a href="{{ route('contato') }}" class="button is-secondary w-button">Contato</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="header1_image-wrapper">
                                        <img alt="" src="{{ asset('temas/Lumialto/assets/images/relume-291627.jpeg') }}" loading="eager"
                                            class="header1_image" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="layout253_component">
                                <div class="w-layout-grid layout253_content">
                                    <div class="layout253_content-left">
                                        ...
                                        <p class="text-size-medium">
                                            Na Lumiauto, oferecemos serviços
                                            que garantem a performance e a
                                            estética do seu carro. Conheça
                                            nossas especialidades e descubra
                                            como podemos cuidar do seu
                                            veículo.
                                        </p>
                                        <div class="margin-top margin-medium">
                                            <div class="button-group">
                                                <a  onclick="openWhatsAppModal()" class="button w-button">Orçamento</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="w-layout-grid layout253_list">
                                        <div class="layout253_item">
                                            ...
                                            <p class="text-size-medium">
                                                Removemos amassados leves
                                                preservando a pintura
                                                original.
                                            </p>
                                        </div>
                                        <div class="layout253_item">
                                ...
                                <div class="testimonial4_component">
                                    <div class="testimonial4_content">
                                            ...
                                            <div class="testimonial4_rating-wrapper">
                                                <div class="testimonial4_rating-icon">
                                                    <div class="icon-embed-xsmall w-embed">
                                                        <svg width="100%" viewbox="0 0 18 17" fill="none"
                                                            >
                                                            <path
                                        ...
                                        <h3 class="heading-style-h5">
                                            &quot;O serviço da Lumiauto
                                            superou minhas expectativas! Meu
                                            carro ficou como novo e o
                                            atendimento foi
                                            excepcional.&quot;
                                        </h3>
                                        <div class="margin-top margin-medium">
                                            <div class="testimonial4_client">
                                                <div class="testimonial4_client-image-wrapper">
                                                    <img alt="" src="{{ asset('temas/Lumialto/assets/images/Face1.jpeg') }}" loading="eager"
                                                        class="testimonial4_client-image" />
                                                </div>
