...
<main class="main-wrapper">
      <header class="section_header64 color-scheme-5">
                ...
                <div class="text-align-center">
                  <div class="max-width-large align-center">
                    <div class="margin-bottom margin-small">
                      <h1 class="heading-style-h1">Martelinho de Ouro</h1>
                    </div>
                    <p class="text-size-medium">Remova amassados leves sem danificar a pintura original do seu veículo com nossa técnica especializada.</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="layout3_component">
                <div class="w-layout-grid layout3_content">
                  <div class="layout3_content-left">
                    <div class="margin-bottom margin-small">
                      <h2 class="heading-style-h3">Martelinho de Ouro: A Solução Ideal para Amassados no Seu Veículo</h2>
                    </div>
                    <p class="text-size-medium">O Martelinho de Ouro é uma técnica não invasiva que remove amassados leves sem danificar a pintura original do seu carro. Com um acabamento impecável, garantimos que seu veículo mantenha sua estética e valor de mercado.</p>
                  ...
                  <div class="layout3_image-wrapper"><img alt="" src="{{ asset('temas/Lumialto/assets/images/relume-291769.jpeg') }}" loading="eager" class="layout3_image"></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="section_layout237 color-scheme-4" style=" background-color: #b2b2b2;">
        <div class="padding-global">
          <div class="container-large">
            <div class="padding-section-large">
                  ...
                  <div class="text-align-center">
                    <div class="max-width-large align-center">
                      <div class="margin-bottom margin-xsmall">
                        <div class="text-style-tagline text-size-medium">Precisão</div>
                      </div>
                      <div class="margin-bottom margin-small">
                        <h2 class="heading-style-h2 text-size-medium">Como Funciona o Martelinho de Ouro</h2>
                      </div>
                      <p class="text-size-medium">O Martelinho de Ouro é um método inovador para remover amassados sem danificar a pintura do seu veículo. Ideal para pequenos danos como batidas leves e granizo, esse processo é rápido e eficaz.</p>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="layout237_item">
                    <div class="margin-bottom margin-small">
                      <div class="layout237_item-icon-wrapper">
                        <div class="icon-1x1-medium w-embed text-size-medium"><svg  width="100%" height="100%" viewbox="0 -960 960 960">
                            <path fill="currentColor" d="M337.17-756.41q-10.32 10.19-23.93 10.19t-23.81-10.19l-57.78-57.55q-10.19-10.19-10.19-23.87 0-13.67 10.19-23.87 10.2-10.19 23.87-10.19 13.68 0 24.11 10.19l57.54 57.55q10.2 10.19 10.2 23.87 0 13.67-10.2 23.87Zm285.78 0q-10.32-10.2-10.32-23.87 0-13.68 10.44-23.87l57.54-57.78q10.19-10.2 23.87-10.08 13.67.12 23.87 10.43 10.19 10.32 10.31 23.87.12 13.56-10.31 23.75l-57.55 57.55q-10.32 10.19-23.93 10.19t-23.92-10.19Zm-143.13-33.87q-14.49 0-24.19-9.82-9.7-9.82-9.7-24.25v-107.56q0-14.4 9.88-24.35 9.87-9.96 24.37-9.96 14.49 0 24.19 9.96 9.7 9.95 9.7 24.35v107.56q0 14.43-9.88 24.25-9.87 9.82-24.37 9.82ZM114.02-37.85v-306.63q0-5.14.62-10.53.62-5.38 2.86-10.86l77.52-234.33q6.72-21.39 24.5-33.94 17.78-12.56 39.91-12.56h441.14q22.13 0 39.91 12.56 17.78 12.55 24.74 33.94l77.28 234.33q2.24 5.48 2.98 10.86.74 5.39.74 10.53v306.87q0 17.96-12.7 30.54Q820.83 5.5 802.69 5.5q-18.02 0-30.59-12.75-12.58-12.76-12.58-30.6V-78.5H200.48v40.89q0 17.96-12.64 30.54Q175.19 5.5 157.13 5.5q-18.2 0-30.65-12.75-12.46-12.76-12.46-30.6Zm91.61-376.63h548.98l-54.28-163.85H259.67l-54.04 163.85Zm81.33 218.81q23 0 38.62-15.75 15.62-15.75 15.62-38.25 0-23.34-15.87-39.67-15.87-16.33-38.13-16.33-23.58 0-39.79 16.26-16.21 16.27-16.21 39.5 0 23.24 16.14 38.74 16.15 15.5 39.62 15.5Zm387.08 0q23.34 0 39.67-15.75 16.33-15.75 16.33-38.25 0-23.34-16.26-39.67-16.27-16.33-39.5-16.33-23.24 0-38.74 16.26-15.5 16.27-15.5 39.5 0 23.24 15.75 38.74 15.75 15.5 38.25 15.5Zm-491.89 49.04h595.7v-207.85h-595.7v207.85Zm0 0v-207.85 207.85Z"></path>
                          </svg></div>
                      </div>
                    </div>
                    <div class="margin-bottom margin-small">
                      <h3 class="heading-style-h4 text-size-medium">Tipos de Danos que Podem Ser Reparados</h3>
                    </div>
                    <p class="text-size-medium">Amassados de estacionamentos apertados, batidas leves e danos causados por granizo são facilmente reparáveis.</p>
                  </div>
                  <div class="layout237_item">
                    <div class="margin-bottom margin-small">
                      <div class="layout237_item-icon-wrapper">
                        <div class="icon-1x1-medium w-embed text-size-medium"><svg  width="100%" height="100%" viewbox="0 -960 960 960">
                            <path fill="currentColor" d="M91.33-237.17q-12.68-5.96-16.78-19.01-4.09-13.06 1.62-25.73l217.24-427q5.96-12.68 19.39-16.16 13.44-3.47 26.11 2.24 12.44 5.96 16.54 19.01 4.09 13.06-1.86 25.49l-217 427.24q-5.96 12.68-19.39 16.16-13.44 3.47-25.87-2.24Zm264 0q-12.68-5.96-16.78-19.01-4.09-13.06 1.62-25.73l217.24-427q5.96-12.68 19.39-16.16 13.44-3.47 26.11 2.24 12.44 5.96 16.54 19.01 4.09 13.06-1.86 25.49l-217 427.24q-5.96 12.68-19.39 16.16-13.44 3.47-25.87-2.24Zm264 0q-12.68-5.96-16.78-19.01-4.09-13.06 1.62-25.73l217.24-427q5.96-12.68 19.39-16.16 13.44-3.47 26.11 2.24 12.44 5.96 16.54 19.01 4.09 13.06-1.86 25.49l-217 427.24q-5.96 12.68-19.39 16.16-13.44 3.47-25.87-2.24Z"></path>
                          </svg></div>
                      </div>
                    </div>
                    <div class="margin-bottom margin-small">
                      <h3 class="heading-style-h4 text-size-medium">Passos do Processo de Martelinho de Ouro</h3>
                    </div>
                    <p class="text-size-medium">Iniciamos com uma avaliação do dano, seguido pela aplicação da técnica não invasiva para restaurar a forma original.</p>
                  </div>
                  <div class="layout237_item">
                    <div class="margin-bottom margin-small">
                      <div class="layout237_item-icon-wrapper">
                    ...
                    <div class="margin-bottom margin-small">
                      <h3 class="heading-style-h4 text-size-medium">Benefícios do Martelinho de Ouro</h3>
                    </div>
                    <p class="text-size-medium">Preservação da pintura original e alta qualidade no acabamento são os principais benefícios.</p>
                  </div>
                </div>
                <div class="margin-top margin-xxlarge">
                  <div class="button-group is-center">
                    <a  onclick="openWhatsAppModal()" class="button w-button">Saiba Mais</a>
                    <a  onclick="openWhatsAppModal()" class="button is-link is-icon is-alternate w-inline-block">
                      <div class="text-size-medium">Agende</div>
                      <div class="icon-embed-xxsmall w-embed text-size-medium"><svg width="16" height="16" viewbox="0 0 16 16" fill="none" >
              ...
              <div class="layout4_component">
                <div class="w-layout-grid layout4_content">
                  <div class="layout4_content-left">
                    <div class="margin-bottom margin-xsmall">
                      <div class="text-style-tagline">Excelência</div>
                    </div>
                    <div class="margin-bottom margin-small">
                      <h2 class="heading-style-h2">Benefícios do Martelinho de Ouro</h2>
                    </div>
                    <div class="margin-bottom margin-medium">
                      <p class="text-size-medium">O Martelinho de Ouro oferece soluções eficazes para amassados leves, garantindo a integridade da pintura. Com técnicas avançadas, devolvemos a estética original do seu veículo.</p>
                    </div>
                    <div class="w-layout-grid layout4_item-list">
                      <div class="layout4_text-wrapper">
                        <div class="margin-bottom margin-xsmall">
                          <h3 class="heading-style-h6">Técnica Não Invasiva</h3>
                        </div>
                        <p>Remoção de amassados sem danificar a pintura original do seu carro.</p>
                      </div>
                      <div class="layout4_text-wrapper">
                        <div class="margin-bottom margin-xsmall">
                          <h3 class="heading-style-h6">Preservação da Pintura</h3>
                        </div>
                        <p>Mantemos a pintura original intacta, garantindo um acabamento perfeito.</p>
                      </div>
                    </div>
                    <div class="margin-top margin-medium">
                      <div class="button-group">
                        <a  onclick="openWhatsAppModal()" class="button w-button">Saiba Mais</a>
                        <a  onclick="openWhatsAppModal()" class="button is-link is-icon w-inline-block">
                          <div>Agende</div>
                  ...
                  <div class="layout4_image-wrapper"><img alt="" src="{{ asset('temas/Lumialto/assets/images/relume-291741.jpeg') }}" loading="eager" class="layout4_image"></div>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="testimonial10_component">
                <div data-delay="4000" data-animation="slide" class="testimonial10_slider w-slider" data-autoplay="false" data-easing="ease" data-hide-arrows="false" data-disable-swipe="false" data-autoplay-limit="0" data-nav-spacing="3" data-duration="500" data-infinite="true">
                  <div class="testimonial10_mask w-slider-mask">
                    <div class="testimonial10_slide w-slide">
                      <div class="testimonial10_content">
                        ...
                        <h3 class="heading-style-h5">&quot;O serviço de Martelinho de Ouro da Lumiauto superou minhas expectativas. O carro ficou como novo, sem marcas ou danos visíveis!&quot;</h3>
                        <div class="margin-top margin-medium">
                          <div class="testimonial10_client">
                            <div class="testimonial10_client-image-wrapper"><img loading="lazy" src="{{ asset('temas/Lumialto/assets/images/Face1.jpeg') }}" alt="" class="testimonial10_client-image"></div>
                            <div class="testimonial10_client-info">
                              <div class="text-weight-semibold">Carlos Silva</div>
                    ...
                    <div class="testimonial10_slide w-slide">
                      <div class="testimonial10_content">
                        ...
                        <h3 class="heading-style-h5">&quot;A equipe da Lumiauto foi extremamente profissional e rápida. Recomendo a todos que precisam de um serviço de qualidade!&quot;</h3>
                        <div class="margin-top margin-medium">
                          <div class="testimonial10_client">
                            <div class="testimonial10_client-image-wrapper"><img loading="lazy" src="{{ asset('temas/Lumialto/assets/images/Face2.jpeg') }}" alt="" class="testimonial10_client-image"></div>
                            <div class="testimonial10_client-info">
                              <div class="text-weight-semibold">Ana Costa</div>
                              <div>Diretora, AutoLovers</div>
                            </div>
                            <div class="divider-vertical"></div>
                          </div>
                        </div>
                  ...
                  <div class="slider-arrow is-centre-previous w-slider-arrow-left">
                    <div class="slider-arrow-icon_default w-embed"><svg width="100%" height="100%" viewbox="0 0 16 16" fill="none" >
      ...
      <section class="section_contact19 color-scheme-5">
        <div class="padding-global">
          <div class="container-large">
            <div class="padding-section-large">
              <div class="contact19_component">
                <div class="margin-bottom margin-xxlarge">
                  <div class="max-width-large">
                    ...
                    <p class="text-size-medium">Agende seu orçamento para Martelinho de Ouro hoje!</p>
                  </div>
                </div>
                <div class="w-layout-grid contact19_grid-list">
                  <div class="contact19_item">
                    <div class="margin-bottom margin-small">
                      <div class="contact19_icon-wrapper">
                        <div class="icon-embed-medium w-embed"><svg  width="100%" height="100%" viewbox="0 0 24 24" fill="none" preserveaspectratio="xMidYMid meet" aria-hidden="true" role="img">
                    ...
                    <div class="margin-bottom margin-xsmall">
                      <h3 class="heading-style-h4">E-mail</h3>
                    </div>
                    <p>Entre em contato para mais informações sobre nossos serviços.</p>
                    <div class="margin-top margin-small">
                      <a href="mailto:{{ \App\Helpers\NavbarHelper::getEmailContato() }}" class="text-style-link">{{ \App\Helpers\NavbarHelper::getEmailContato() }}</a>
                    </div>
                  </div>
                  <div class="contact19_item">
                    <div class="margin-bottom margin-small">
                    ...
                    <div class="margin-bottom margin-xsmall">
                      <h3 class="heading-style-h4">Telefone</h3>
                    </div>
                    <p>Estamos disponíveis para atender suas necessidades automotivas.</p>
                    <div class="margin-top margin-small">
                      <a href="tel:+55{{ preg_replace('/[^0-9]/', '', \App\Helpers\NavbarHelper::getTelefone()) }}" class="text-style-link">{{ \App\Helpers\NavbarHelper::getTelefone() }}</a>
                    </div>
                  </div>
                  <div class="contact19_item">
                    <div class="margin-bottom margin-small">
                    ...
                    <div class="margin-bottom margin-xsmall">
                      <h3 class="heading-style-h4">Endereço</h3>
                    </div>
                    <p>Visite-nos para um atendimento personalizado e de qualidade.</p>
                    <div class="margin-top margin-small">
                      <a href="#" class="text-style-link">SIA Trecho 3 - Guará, Brasília</a>
                    </div>
                  </div>
                </div>
              </div>
