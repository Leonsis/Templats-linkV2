<head>
    ...
    @else
        <title>{{ \App\Helpers\HeadHelper::getMetaTitle($currentPage ?? 'global', 'Dentista24h') }}</title>
        <meta name="description" content="{{ \App\Helpers\HeadHelper::getMetaDescription($currentPage ?? 'global', 'Dentista24h') }}">
        <meta name="keywords" content="{{ \App\Helpers\HeadHelper::getMetaKeywords($currentPage ?? 'global', 'Dentista24h') }}">
    @endif
    ...
    <link href="{{ asset('temas/Dentista24h/assets/css/normalize.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('temas/Dentista24h/assets/css/webflow.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('temas/Dentista24h/assets/css/griffo-ef20db.webflow.css') }}" rel="stylesheet" type="text/css">
    ...
    <link href="{{ asset('temas/Dentista24h/assets/images/webclip.webp') }}" rel="apple-touch-icon">
    @php
