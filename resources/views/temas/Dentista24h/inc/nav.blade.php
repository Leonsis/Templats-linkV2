    ...
    <section class="home-banner first-version">
        ...
        <div class="container-large w-container">
            ...
            <a href="{{ route('home') }}" aria-current="page" class="navbar-brand w-nav-brand w--current">
                <img src="{{ \App\Helpers\NavbarHelper::getLogo() }}" loading="lazy" width="127" sizes="127px" alt="" class="navbar-brand-logo">
            </a>
            ...
            <div class="nav-menu-whole-area">
                ...
                <div class="nav-link-area">
                    ...
                    <a href="{{ route('sobre') }}" class="nav-link w-nav-link">Sobre Nós</a>
                    <div data-hover="true" data-delay="0" class="nav-dropdown large w-dropdown">
                        ...
                        <nav class="nav-dropdown-list large w-dropdown-list">
                            <div class="nav-dropdown-link-holder">
                                <div>
                                    <div>
                                        <a href="{{ route('tema.Dentista24h.seguranca-de-eventos') }}"  class="nav-dropdown-link w-dropdown-link">Segurança de Eventos</a>
                                        <a href="{{ route('tema.Dentista24h.gerenciamento-condominios') }}" class="nav-dropdown-link w-dropdown-link">Gerenciamento Condomínios</a>
                                        <a href="{{ route('tema.Dentista24h.seguranca-patrimonial') }}" class="nav-dropdown-link w-dropdown-link">Segurança Patrimonial</a>
                                        <a href="{{ route('tema.Dentista24h.terceirizacao-geral') }}" class="nav-dropdown-link w-dropdown-link">Terceirização Geral</a>
                                    </div>
                                </div>
                            </div>
                        </nav>
                    </div>
                    <a href="{{ route('contato') }}" class="nav-link w-nav-link">Contato</a>
                    <a href="{{ route('tema.Dentista24h.blogs') }}" class="nav-link w-nav-link">Blog</a>
        ...
        <div class="nav-link-area">
            ...
            <a href="{{ route('sobre') }}" class="nav-link">Sobre Nós</a>
            <a href="{{ route('contato') }}" class="nav-link">Contato</a>
            <a href="{{ route('tema.Dentista24h.blogs') }}" class="nav-link">Blog</a>
        </div>
        <div class="nav-button-wrap">
