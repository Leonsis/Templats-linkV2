...
<main class="main-wrapper">
  <header class="section_header54 text-color-white">
          ...
          <div class="header54_component">
            <div class="max-width-large">
              <div class="margin-bottom margin-small">
                <h1 class="heading-style-h1">Fale Conosco</h1>
              </div>
              <p class="text-size-medium">Estamos aqui para ajudar! Entre em contato e tire suas dúvidas.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="header54_background-image-wrapper">
      <div class="image-overlay-layer"></div><img alt="" src="{{ asset('temas/Mental-ice/assets/images/relume-282077.jpeg') }}" loading="eager" class="header54_background-image">
    </div>
  </header>
  <section class="section_contact2 color-scheme-4">
    <div class="padding-global">
      <div class="container-large">
        <div class="padding-section-large">
            ...
            <div class="margin-bottom margin-xxlarge">
              <div class="text-align-center">
                <div class="max-width-large align-center">
                  ...
                  <p class="text-size-medium">Estamos aqui para ajudar você!</p>
                </div>
              </div>
            </div>
            <div class="max-width-large align-center">
              <div class="contact2_form-block w-form">
                <form id="wf-form-Contact-2-Form" name="wf-form-Contact-2-Form" data-name="Contact 2 Form" method="get" class="contact2_form" data-wf-page-id="68b82edb656799804799aa2b" data-wf-element-id="1f0fca29-c116-266e-d6d3-eb42cfaebc1c">
                  <div class="form_field-2col">
                    <div class="form_field-wrapper"><label for="Contact-2-First-Name-2" class="form_field-label">Nome</label><input class="form_input w-input" maxlength="256" name="Contact-2-First-Name" data-name="Contact 2 First Name" placeholder="" type="text" id="Contact-2-First-Name-2" required=""></div>
                    <div class="form_field-wrapper"><label for="Contact-2-Last-Name" class="form_field-label">Sobrenome</label><input class="form_input w-input" maxlength="256" name="Contact-2-Last-Name" data-name="Contact 2 Last Name" placeholder="" type="text" id="Contact-2-Last-Name" required=""></div>
                  </div>
                  <div class="form_field-2col is-mobile-1col">
                    ...
                    <div class="form_field-wrapper"><label for="Contact-2-Phone" class="form_field-label">Telefone</label><input class="form_input w-input" maxlength="256" name="Contact-2-Phone" data-name="Contact 2 Phone" placeholder="" type="tel" id="Contact-2-Phone" required=""></div>
                  </div>
                  <div class="form_field-wrapper"><label for="Contact-2-Message" class="form_field-label">Mensagem</label><textarea id="Contact-2-Message" name="Contact-2-Message" maxlength="5000" data-name="Contact 2 Message" placeholder="Digite sua mensagem..." required="" class="form_input is-text-area w-input"></textarea></div>
                  <div class="margin-bottom margin-xsmall"><label id="Contact-2-Checkbox" class="w-checkbox form_checkbox">
                      <div class="w-checkbox-input w-checkbox-input--inputType-custom form_checkbox-icon"></div><input type="checkbox" name="Contact-2-Checkbox" id="Contact 2 Checkbox" data-name="Contact 2 Checkbox" required="" style="opacity:0;position:absolute;z-index:-1"><span for="Contact-2-Checkbox" class="form_checkbox-label w-form-label">Aceito os Termos</span>
                    </label></div><input type="submit" data-wait="Please wait..." id="w-node-_1f0fca29-c116-266e-d6d3-eb42cfaebc5a-4799aa2b" class="button w-button" value="Enviar">
                </form>
                <div class="form_message-success-wrapper w-form-done">
                  <div class="form_message-success">
                    <div class="success-text">Obrigado! Sua mensagem foi recebida!</div>
                  </div>
                </div>
  ...
  <section class="section_contact20 color-scheme-3">
    <div class="padding-global">
      <div class="container-large">
        <div class="padding-section-large">
          <div class="contact20_component">
            <div class="margin-bottom margin-xxlarge">
              <div class="text-align-center">
                <div class="max-width-large align-center">
                  <div class="margin-bottom margin-xsmall">
            ...
            <div class="w-layout-grid contact20_grid-list">
              <div class="contact20_item">
                <div class="margin-bottom margin-small">
                  <div class="contact20_icon-wrapper">
                ...
                <p>Envie suas dúvidas e sugestões para nós.</p>
                <div class="margin-top margin-small">
                  <a href="#" class="text-style-link">contato@mentalicebath.com</a>
                </div>
              </div>
              <div class="contact20_item">
                <div class="margin-bottom margin-small">
                ...
                <p>Estamos disponíveis para atender você.</p>
                <div class="margin-top margin-small">
                  <a href="#" class="text-style-link">+55 (11) 0000-0000</a>
                </div>
              </div>
              <div class="contact20_item">
                <div class="margin-bottom margin-small">
                ...
                <div class="margin-bottom margin-xsmall">
                  <h3 class="heading-style-h4">Escritório</h3>
                </div>
                <p>Nosso endereço.</p>
                <div class="margin-top margin-small">
                  <a href="#" class="text-style-link">Rua Real Grandeza, 122 – Botafogo, Rio de Janeiro – RJ</a>
                </div>
              </div>
            </div>
          </div>
